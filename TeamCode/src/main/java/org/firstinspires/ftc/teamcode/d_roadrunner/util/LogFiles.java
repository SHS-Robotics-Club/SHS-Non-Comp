package org.firstinspires.ftc.teamcode.d_roadrunner.util;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double trackingTicksPerRev = OdometryPodLocalizer.TICKS_PER_REV;
        public double trackingWheelRadius = OdometryPodLocalizer.WHEEL_RADIUS;
        public double trackingGearRatio = OdometryPodLocalizer.GEAR_RATIO;
        public double trackingLateralDistance = OdometryPodLocalizer.LATERAL_DISTANCE;
        public double trackingForwardOffset = OdometryPodLocalizer.FORWARD_OFFSET;
