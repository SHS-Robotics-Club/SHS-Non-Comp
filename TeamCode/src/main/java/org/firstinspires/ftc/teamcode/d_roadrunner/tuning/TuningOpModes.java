...
import org.firstinspires.ftc.teamcode.d_roadrunner.OdometryPodLocalizer;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(MecanumDrive.class)) {
            dvf = hardwareMap -> {
                ...
                } else if (md.localizer instanceof OdometryPodLocalizer) {
                    OdometryPodLocalizer dl = (OdometryPodLocalizer) md.localizer;
                    parEncs.add(dl.par0);
                    parEncs.add(dl.par1);
